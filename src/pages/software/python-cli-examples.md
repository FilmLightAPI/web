...
description: Basic FLAPI examples for command-line tools writen in Python
icon: /web/icons/python-cli-examples.png
category: FLAPI Tools
download: /web/downloads/python-cli-examples.zip
---
...
- **find_by_timecode.py** Find if a timecode range is in a given movie or file sequence
